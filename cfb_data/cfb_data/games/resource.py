...
_MediaTypeArgument: TypeAlias = (
    MediaType | Literal["tv", "radio", "web", "ppv", "mobile"]
)
_CompetitionArgument: TypeAlias = PlayoffCompetition | Literal["cfp"]
_RoundArgument: TypeAlias = (
...
class GamesResource(Generic[_FrameT]):
    ...
    @overload
    async def list(self, request: GamesRequest, /) -> _FrameT: ...
    ...
    @overload
    async def records(self, request: RecordsRequest, /) -> _FrameT: ...
    ...
    @overload
    async def calendar(self, request: CalendarRequest, /) -> _FrameT: ...
    ...
    @overload
    async def scoreboard(self, request: ScoreboardRequest, /) -> _FrameT: ...
    ...
    @overload
    async def media(self, request: GameMediaRequest, /) -> _FrameT: ...
    ...
    @overload
    async def weather(self, request: GameWeatherRequest, /) -> _FrameT: ...
    ...
    @overload
    async def team_stats(self, request: TeamGameStatsRequest, /) -> _FrameT: ...
